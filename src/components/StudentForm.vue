...
<!-- add server-side validation （Extension C）-->
...
const props = defineProps({
  ...
  // Extension C: 從 App.vue 接收 server 回來的錯誤
...
// Extension C: 當 serverErrors 改變時，合並到 errors 裡
...
<template>
  <form @submit.prevent="onSubmit" class="student-form">
    ...
    <label>GPA
      <input v-model.number="form.gpa" type="number" step="0.01" min="0" max="4" />
